...
while (ch!='q')
{
   ...
   case 'c':
   cout << "Funzione non disponibile ";
   break;


  case 'd':
   cout << "\ndigitare s seguito elemento e indice >";
   cin >> ch; 
   if (ch == 's') 
      {
       cin >> e >> i;
   ...
   case 'e':
   cout << "\ndigitare s seguito da elemento e indice >";
   cin >> ch; 
   if (ch == 's') 
      {
       cin >> e >> i;
